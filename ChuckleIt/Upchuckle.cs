...
namespace ChuckleIt
{
    ...
    public delegate bool UniquenessReferee(string someJoke, string otherJoke);

    public interface IChucksKeeper {
        bool IsAlreadyThere(string suspect, UniquenessReferee judge);
        void KeepHim(string suspect);
    }
}
